...
namespace Hk.Infrastructures.Mongo.Repository
{
        ...
        where T : IEntity<TKey>
    {
        ...
        /// </summary>
        /// <param name="connectionStringName">ConnectionStringName to use for connecting to MongoDB.</param>
        public MongoRepository(string connectionStringName)
           
        {
            this.collection = MongoObject<TKey>.GetConnectionString<T>(connectionStringName);
        }
        ...
        {
            this.collection = MongoObject<TKey>.GetCollectionFromConnectionString<T>(connectionString, collectionName);
        }
        ...
        {
            this.collection = MongoObject<TKey>.GetCollectionFromUrl<T>(url);
        }
        ...
        {
            this.collection = MongoObject<TKey>.GetCollectionFromUrl<T>(url, collectionName);
        }
