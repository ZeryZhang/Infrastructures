...
namespace Hk.Infrastructures.Mongo.Repository
{
        ...
        where T : IEntity<TKey>
    {
        ...
        public MongoRepositoryManager(string connectionStringName)
        {
    ...
    public class MongoRepositoryManager<T> : MongoRepositoryManager<T, string>, IMongoRepositoryManager<T>
